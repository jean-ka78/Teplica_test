...
void io_poll() {
  ...
  s_data.f = Tmax;
  slave_data[16] = s_data.u[0];
  // slave_data_3[16] = s_data.u[0];
  slave_data[17] = s_data.u[1];
  // slave_data_3[17] = s_data.u[1];
   s_data.f = Tmin;
  slave_data[18] = s_data.u[0];
  // slave_data_3[18] = s_data.u[0];
  slave_data[19] = s_data.u[1];
  // slave_data_3[19] = s_data.u[1];
   s_data.f = Tmax_i;
  slave_data[20] = s_data.u[0];
  // slave_data_3[20] = s_data.u[0];
  slave_data[21] = s_data.u[1];
  // slave_data_3[21] = s_data.u[1];
   s_data.f = Tmin_i;
  slave_data[22] = s_data.u[0];
  // slave_data_3[22] = s_data.u[0];
  slave_data[23] = s_data.u[1];
...
temp_on = slave_data[25];
temp_off = slave_data[26];
